 ...
 */
int
lista_insertar_inicio(lista_t *lista, void *elemento)
{
	if (!lista)
		return FALLO;
 ...
 */
nodo_t *
nodo_en_posicion(lista_t *lista, size_t posicion)
{
	if (!lista)
		return NULL;
...
int
lista_borrar_de_posicion(lista_t *lista, size_t posicion)
{
	if (!lista)
		return FALLO;
	if (lista->cantidad == 0)
...
int
lista_apilar(lista_t *lista, void *elemento)
{
	return lista_insertar_inicio(lista, elemento);
}

int
lista_desapilar(lista_t *lista)
{
	return lista_borrar_de_posicion(lista, 0);
}

void *
lista_tope(lista_t *lista)
{
	return lista_elemento_en_posicion(lista, 0);
}

int
lista_encolar(lista_t *lista, void *elemento)
{
	return lista_insertar(lista, elemento);
}

int
lista_desencolar(lista_t *lista)
{
	return lista_borrar_de_posicion(lista, 0);
}
...
size_t
lista_con_cada_elemento(lista_t *lista,
